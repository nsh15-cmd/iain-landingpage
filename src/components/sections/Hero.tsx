      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        >
          ...
          <Paragraph className="mt-8">
            IAIN is a next-generation meeting platform built for modern work.
            With powerful video conferencing, built-in collaboration tools,
            continuous meeting chat, and best-in-class audio, it creates a
            seamless environment for interviewers and interviewees. Experience
            smarter, more connected interviews that make every conversation
          ...
          <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
            <div className="flex sm:flex-row flex-col gap-5 w-full">
              ...
              >
                ...
                <input
                  type="email"
                  placeholder="jacobsomoook@gmail.com"
